#!/usr/bin/env python3
"""Narrow legacy MCP bridge for Open Ephys v1.0.2 agent contract 0.0.2."""
...
DEFAULT_CONTRACT = Path(__file__).with_name("open_ephys_agent_contract_v1_0_2_v0_0_2.json")
TOOL_NAMES = (
