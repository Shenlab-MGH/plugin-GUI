...
TEST (ProcessorInventoryApiHandlerTests, BuildsTheCompleteOfficialSnapshotInsideOneDispatchedOperation)
{
...
TEST (ProcessorInventoryApiHandlerTests, MapsDispatchAndReadFailuresToStableErrors)
{
    struct Case
    {
        int expectedStatus;
