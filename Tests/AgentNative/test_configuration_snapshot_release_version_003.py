"""Assert every active configuration-snapshot product surface is literal 0.0.3.
...
class ConfigurationSnapshotReleaseVersion003Tests(unittest.TestCase):
    ...
    def test_active_contract_and_parity_filenames_are_0_0_3(self):
        ...
        self.assertIn("0_0_3", CONTRACT_PATH.name)
        self.assertIn("0_0_3", PARITY_PATH.name)
        self.assertNotIn("r0_1_0", CONTRACT_PATH.name)
        self.assertNotIn("r0_1_0", PARITY_PATH.name)

    def test_agent_contract_product_versions_are_literal_0_0_3(self):
    ...
    def test_parity_report_schema_version_is_literal_0_0_3(self):
