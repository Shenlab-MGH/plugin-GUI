...
class ContractTests(unittest.TestCase):
    def test_contract_is_pinned_to_narrow_v11_core_0_0_1(self):
        ...
        self.assertEqual(contract["baseline"]["upstream"], "open-ephys/plugin-GUI")
        self.assertEqual(contract["baseline"]["version"], "1.1.0")
        self.assertEqual(contract["mcp"]["protocol_version"], "2024-11-05")
        self.assertFalse(contract["mcp"]["modern_protocol_supported"])
        self.assertEqual(contract["mcp"]["server_name"], "open-ephys-agent-native")
...
class McpR010Tests(unittest.TestCase):
    ...
    def test_skill_pins_contract_and_safety_boundary(self):
        ...
        for required in ("0.0.1", "1.1.0", "2024-11-05", "approve_recording=true", "oe_get_recording_options", "oe_get_disk", "oe_get_time"):
