...
| Source/UI/ControlPanel.cpp | MODIFIED | Official acquisition/record buttons | Routes semantic origins while retaining official controls | Control parity | command routing and GUI acceptance | Agent mode off |
