...
const std::vector<ControlCapability>& getCoreControlCapabilities()
{
    static const std::vector<ControlCapability> capabilities {
        ...
        { "oe.control.recording.engine", "Recording engine", "Choose the default recording engine for future Record Nodes.",
          ControlCapabilityKind::selection, "oe.control.recording.engine",
          { { "read", "GET", "/api/recording", {}, { "default_record_engine" } },
            { "set", "PUT", "/api/recording", { "default_record_engine" }, { "default_record_engine" } } } },
