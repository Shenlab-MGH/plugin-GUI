...
const std::vector<ControlCapability>& getCoreControlCapabilities()
{
    ...
    static const std::vector<ControlCapability> capabilities {
        ...
        { "oe.control.signal_chain.configuration", "Signal chain configuration", "Read the current signal chain configuration.",
          ControlCapabilityKind::collection, {},
          { { "read", "GET", "/api/config", {}, { "info" } } } },
        { "oe.control.signal_chain.processors", "Loaded processors", "Read the processors currently loaded in the signal chain.",
          ControlCapabilityKind::collection, "oe.control.signal_chain.processors",
          { { "read", "GET", "/api/processors", {}, { "processors" } } } },
