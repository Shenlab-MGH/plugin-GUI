...
private:
    void registerRoutes (httplib::Server& server, MessageThreadCallGeneration& generation)
    {
        ...
        svr_->Put ("/api/audio", [this] (const httplib::Request& req, httplib::Response& res)
                ...
                update.deviceType = optionalSettingsField<std::string> (request_json, "device_type");
        ...
        svr_->Put ("/api/recording", [this, &generation] (const httplib::Request& req, httplib::Response& res)
                ...
                update.prependText = optionalSettingsField<std::string> (request_json, "prepend_text");
                update.baseText = optionalSettingsField<std::string> (request_json, "base_text");
