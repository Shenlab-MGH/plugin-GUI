...
$contracts = @(
    ...
    'Tests\AgentContracts\test_recording_safety_integration_source.py',
    'Tests\AgentContracts\test_preset_capability_probe_source.py',
    'Tests\AgentContracts\test_file_reader_qualification_source.py'
)
