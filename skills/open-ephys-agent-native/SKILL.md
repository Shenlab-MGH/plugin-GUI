...
description: Safely inspect and control the Open Ephys v1.1.0 core through the 0.0.1 MCP tools. Use for capability discovery, acquisition or recording mode changes, recording options, filename changes, and CPU/disk/time status reads on the Windows Open Ephys agent-native build.
---
