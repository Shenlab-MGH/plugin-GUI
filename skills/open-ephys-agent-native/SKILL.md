...
This Skill is pinned to Open Ephys GUI `1.0.2`, agent contract `0.0.2`, API
capability contract `0.0.2`, and legacy MCP protocol `2024-11-05`.
...
Every tool independently verifies the exact ten 0.0.2 capabilities. Only
...
listener or C++ change outside the scoped recording-directory capability metadata.
